    ...
    render(){
        return(
            <div className={this.props.navToggle?'mt-56 container':'mt-140 container-fluid'}  >
               ...
               <img class="card-img-top img-responsive" src={this.props.movieDetails.Poster} alt="Card image cap" />
               <div class="card-body">
               ...
               <a class="btn buy cart-link btn-primary shadow"><i class="fas fa-shopping-cart"></i> Add to cart</a>
                ...
                <div class="col-md-8 col-sm-6 col-xs-12 mt-2 mb-2 ">
                 <div class="card shadow">
                    <div class="card-body">                             
                        <h5 class="card-title "> {"Title : "+this.props.movieDetails.Title} </h5>
                        <hr />
                        ...
                        <hr />
                        <p> {"Website : "+this.props.movieDetails.Website} </p>
                        <hr />
